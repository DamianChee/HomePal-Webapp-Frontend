              ...
              <div>
                ...
                <div className="flex space-x-2 items-center">
                  <input 
                    ...
                    onChange={(e) => setDefaultSchedule({...defaultSchedule, start: e.target.value})}
                  ...
                  <input 
                    ...
                    onChange={(e) => setDefaultSchedule({...defaultSchedule, end: e.target.value})}
                    className="flex-1 bg-gray-700 text-white rounded px-3 py-2"
                    aria-label="End time"
                  />
                </div>
